...
class Mapa:
    ...
    def crear_habitacion(self, id, nombre, id_vecinos, objetos):  # COMPLETAR
        ...
        if Habitacion not in self.habitaciones_creadas:
            habitacion = Habitacion(id, nombre, id_vecinos, objetos)
            self.habitaciones_creadas.append(habitacion)
            return habitacion
    ...
    def ingresar_a_habitacion(self, habitacion: Habitacion):
        ...
        if not habitacion.explorada:
            ...
            for vecino_id in habitacion.id_vecinos:
                ...
                nueva_habitacion = self.mapa.crear_habitacion(
                    vecino_id, nombre, id_vecinos, objetos
                )
